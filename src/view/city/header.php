<header>
  <div id="nav-container">
    <nav class="navbar navbar-expand-lg fixed-top cityHeader">
      ...
      <button class="navbar-toggler cityMenuButton" type="button" data-toggle="collapse" data-target="#navbar-links" aria-controls="navbar-links" aria-expanded="false" aria-label="Toggle navigation">
      <span>
